...
export default function App() {
  return (
    <div className='max-w-[1200px], mx-auto flex flex-col items-center my-16'>
      ...
      <h1 className='text-6xl text-white font-black my-2'>Seu
      ...
      <div className='pt-1 mt-8 bg-nlw-gradient self-stretch rounded-lg overflow-hidden'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          ...
          <button className='py-3 px-4 bg-violet-500 text-white rounded-md hover:bg-violet-700 flex items-center gap-3'>
